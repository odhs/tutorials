...
1. Qual objeto do Microsoft Azure contém **múltiplos datacenters** que são **conectados** por uma **rede de baixa latência**?
...
1. Os **conjuntos de disponibilidade** são compostos por quais dos itens a seguir?
...
1. É um contêiner que você usa para gerenciar e agregar recursos em uma única unidade. ​
